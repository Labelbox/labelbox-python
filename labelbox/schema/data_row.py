...
class DataRow(DbObject, Updateable, BulkDeletable):
    ...
    def create_attachment(self,
        ...
        query_str = """mutation CreateDataRowAttachmentPyApi(
            ...
            attachment_type_param, attachment_value_param, attchment_name_param,
            data_row_id_param, attachment_type_param, attachment_value_param,
            attchment_name_param, data_row_id_param,
        ...
        res = self.client.execute(
            query_str, {
                ...
                attchment_name_param: attachment_name,
                data_row_id_param: self.uid
            })

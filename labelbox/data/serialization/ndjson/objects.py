...
from ...annotation_types.classification import Radio, Checklist, Text
from ...annotation_types.annotation import ClassificationAnnotation, ObjectAnnotation, VideoObjectAnnotation
from .classification import NDChecklist, NDSubclassification, NDSubclassificationType, NDRadioSubclass, NDText
...
class NDSegment(BaseModel):
    ...
    def lookup_segment_object_type(
            segment: List[VideoObjectAnnotation]) -> "NDFrameObjectType":
...
class NDSegments(NDBaseObject):
    ...
    @classmethod
    def from_common(cls, segments: List[List[VideoObjectAnnotation]],
                    data: VideoData, feature_schema_id: Cuid,

...
def test_xy_1(output_file):
    labeled_data = os.path.abspath('test-fixtures/labelbox_xy_1.json')
    lb2co.from_json(labeled_data=labeled_data, coco_output=output_file, label_format='XY')

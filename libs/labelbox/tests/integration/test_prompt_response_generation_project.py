...
def test_ontology_create_feature_schema(ontology_from_feature_ids,
                                        features_from_json, classification_json):
    ...
    for classification in classifications:
        generated_tool = next(
            c for c in classifications_normalized if c['name'] == classification['name'])

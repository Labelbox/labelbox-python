...
def test_add_single_model_config(configured_project, model_config):
    ...
    configured_project.remove_project_model_config(project_model_config_id)
...
def test_add_multiple_model_config(client, rand_gen, configured_project, model_config, valid_model_id):
    ...
    [configured_project.remove_project_model_config(project_model_config_id) for project_model_config_id in expected_model_configs]


def test_remove_model_config_from_project(configured_project, model_config):
    assert configured_project.remove_project_model_config(configured_project.add_model_config(model_config.uid))

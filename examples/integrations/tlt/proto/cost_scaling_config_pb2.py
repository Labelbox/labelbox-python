...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/cost_scaling_config.proto',
  package='',
  syntax='proto3',
...
_COSTSCALINGCONFIG = _descriptor.Descriptor(name='CostScalingConfig',
 ...
 _descriptor.FieldDescriptor(name='enabled',
   ...
   json_name='enabled',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='initial_exponent',
...
CostScalingConfig = _reflection.GeneratedProtocolMessageType('CostScalingConfig', (_message.Message,), dict(DESCRIPTOR=_COSTSCALINGCONFIG,

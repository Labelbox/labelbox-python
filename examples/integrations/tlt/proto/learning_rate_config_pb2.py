...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        iva_dot_detectnet__v2_dot_proto_dot_soft__start__annealing__schedule__config__pb2
        .DESCRIPTOR
    ])
_LEARNINGRATECONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='soft_start_annealing_schedule',
    ...
    serialized_end=262)
_LEARNINGRATECONFIG.fields_by_name[
    'soft_start_annealing_schedule'].message_type = iva_dot_detectnet__v2_dot_proto_dot_soft__start__annealing__schedule__config__pb2._SOFTSTARTANNEALINGSCHEDULECONFIG
...
_LEARNINGRATECONFIG.fields_by_name[
    'soft_start_annealing_schedule'].containing_oneof = _LEARNINGRATECONFIG.oneofs_by_name[
        'learning_rate']
DESCRIPTOR.message_types_by_name['LearningRateConfig'] = _LEARNINGRATECONFIG
_sym_db.RegisterFileDescriptor(DESCRIPTOR)
LearningRateConfig = _reflection.GeneratedProtocolMessageType(
    'LearningRateConfig', (_message.Message,),
    dict(DESCRIPTOR=_LEARNINGRATECONFIG,

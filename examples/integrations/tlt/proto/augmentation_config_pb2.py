...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/augmentation_config.proto',
  package='',
  syntax='proto3',
...
_AUGMENTATIONCONFIG_PREPROCESSING = _descriptor.Descriptor(name='Preprocessing',
  full_name='AugmentationConfig.Preprocessing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='output_image_width',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_image_height',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_image_min',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_image_max',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_image_channel',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='crop_left',
   ...
   json_name='cropLeft',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='crop_top',
   ...
   json_name='cropTop',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='crop_right',
   ...
   json_name='cropRight',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='crop_bottom',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='min_bbox_width',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='min_bbox_height',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='scale_width',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='scale_height',
  ...
  serialized_end=836)
_AUGMENTATIONCONFIG_SPATIALAUGMENTATION = _descriptor.Descriptor(name='SpatialAugmentation',
  full_name='AugmentationConfig.SpatialAugmentation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='hflip_probability',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='vflip_probability',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='zoom_min',
   ...
   json_name='zoomMin',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='zoom_max',
   ...
   json_name='zoomMax',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='translate_max_x',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='translate_max_y',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='rotate_rad_max',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='rotate_probability',
   full_name='AugmentationConfig.SpatialAugmentation.rotate_probability',
   index=7,
   number=8,
   type=2,
   cpp_type=6,
  ...
  serialized_end=1169)
_AUGMENTATIONCONFIG_COLORAUGMENTATION = _descriptor.Descriptor(name='ColorAugmentation',
  full_name='AugmentationConfig.ColorAugmentation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='color_shift_stddev',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='hue_rotation_max',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='saturation_shift_max',
   full_name='AugmentationConfig.ColorAugmentation.saturation_shift_max',
   index=2,
   number=3,
   type=2,
   cpp_type=6,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='contrast_scale_max',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='contrast_center',
  ...
  serialized_end=1416)
_AUGMENTATIONCONFIG = _descriptor.Descriptor(name='AugmentationConfig',
  full_name='AugmentationConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='preprocessing',
   full_name='AugmentationConfig.preprocessing',
   index=0,
   number=1,
   type=11,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='spatial_augmentation',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='color_augmentation',
  ...
  extensions=[],
  nested_types=[
 _AUGMENTATIONCONFIG_PREPROCESSING, _AUGMENTATIONCONFIG_SPATIALAUGMENTATION, _AUGMENTATIONCONFIG_COLORAUGMENTATION],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
AugmentationConfig = _reflection.GeneratedProtocolMessageType('AugmentationConfig', (_message.Message,), dict(Preprocessing=(_reflection.GeneratedProtocolMessageType('Preprocessing', (_message.Message,), dict(DESCRIPTOR=_AUGMENTATIONCONFIG_PREPROCESSING,
  __module__='iva.detectnet_v2.proto.augmentation_config_pb2'))),
  SpatialAugmentation=(_reflection.GeneratedProtocolMessageType('SpatialAugmentation', (_message.Message,), dict(DESCRIPTOR=_AUGMENTATIONCONFIG_SPATIALAUGMENTATION,
  __module__='iva.detectnet_v2.proto.augmentation_config_pb2'))),
  ColorAugmentation=(_reflection.GeneratedProtocolMessageType('ColorAugmentation', (_message.Message,), dict(DESCRIPTOR=_AUGMENTATIONCONFIG_COLORAUGMENTATION,
  __module__='iva.detectnet_v2.proto.augmentation_config_pb2'))),

...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/cost_function_config.proto',
  package='',
  syntax='proto3',
...
_COSTFUNCTIONCONFIG_TARGETCLASS_OBJECTIVE = _descriptor.Descriptor(name='Objective',
 ...
 _descriptor.FieldDescriptor(name='name',
   ...
   json_name='name',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='initial_weight',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='weight_target',
  ...
  serialized_end=614)
_COSTFUNCTIONCONFIG_TARGETCLASS = _descriptor.Descriptor(name='TargetClass',
 ...
 _descriptor.FieldDescriptor(name='name',
   ...
   json_name='name',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='class_weight',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='coverage_foreground_weight',
   full_name='CostFunctionConfig.TargetClass.coverage_foreground_weight',
   index=2,
   number=3,
   type=2,
   cpp_type=6,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='objectives',
  ...
  extensions=[],
  nested_types=[
 _COSTFUNCTIONCONFIG_TARGETCLASS_OBJECTIVE],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
  ...
  serialized_end=614)
_COSTFUNCTIONCONFIG = _descriptor.Descriptor(name='CostFunctionConfig',
 ...
 _descriptor.FieldDescriptor(name='target_classes',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='enable_autoweighting',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='max_objective_weight',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='min_objective_weight',
  ...
  extensions=[],
  nested_types=[
 _COSTFUNCTIONCONFIG_TARGETCLASS],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
CostFunctionConfig = _reflection.GeneratedProtocolMessageType('CostFunctionConfig', (_message.Message,), dict(TargetClass=(_reflection.GeneratedProtocolMessageType('TargetClass', (_message.Message,), dict(Objective=(_reflection.GeneratedProtocolMessageType('Objective', (_message.Message,), dict(DESCRIPTOR=_COSTFUNCTIONCONFIG_TARGETCLASS_OBJECTIVE,

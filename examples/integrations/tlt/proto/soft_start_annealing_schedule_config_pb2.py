...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/soft_start_annealing_schedule_config.proto',
  package='',
  syntax='proto3',
...
_SOFTSTARTANNEALINGSCHEDULECONFIG = _descriptor.Descriptor(name='SoftStartAnnealingScheduleConfig',
 ...
 _descriptor.FieldDescriptor(name='min_learning_rate',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='max_learning_rate',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='soft_start',
   ...
   json_name='softStart',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='annealing',
...
SoftStartAnnealingScheduleConfig = _reflection.GeneratedProtocolMessageType('SoftStartAnnealingScheduleConfig', (_message.Message,), dict(DESCRIPTOR=_SOFTSTARTANNEALINGSCHEDULECONFIG,

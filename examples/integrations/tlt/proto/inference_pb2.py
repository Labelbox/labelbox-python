...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/inference.proto',
  package='',
  syntax='proto3',
  ...
  dependencies=[
 iva_dot_detectnet__v2_dot_proto_dot_inferencer__config__pb2.DESCRIPTOR, iva_dot_detectnet__v2_dot_proto_dot_postprocessing__config__pb2.DESCRIPTOR])
_CLASSWISEBBOXHANDLERCONFIG_BBOXCOLOR = _descriptor.Descriptor(name='BboxColor',
  full_name='ClasswiseBboxHandlerConfig.BboxColor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='R',
   ...
   json_name='R',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='G',
 ...
 _descriptor.FieldDescriptor(name='B',
  ...
  serialized_end=434)
_CLASSWISEBBOXHANDLERCONFIG = _descriptor.Descriptor(name='ClasswiseBboxHandlerConfig',
 ...
 _descriptor.FieldDescriptor(name='clustering_config',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='confidence_model',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_map',
   ...
   json_name='outputMap',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='bbox_color',
  ...
  extensions=[],
  nested_types=[
 _CLASSWISEBBOXHANDLERCONFIG_BBOXCOLOR],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
  ...
  serialized_end=434)
_BBOXHANDLERCONFIG_CLASSWISEBBOXHANDLERCONFIGENTRY = _descriptor.Descriptor(name='ClasswiseBboxHandlerConfigEntry',
 ...
 _descriptor.FieldDescriptor(name='value',
  ...
  serialized_end=843)
_BBOXHANDLERCONFIG = _descriptor.Descriptor(name='BboxHandlerConfig',
 ...
 _descriptor.FieldDescriptor(name='kitti_dump',
   ...
   json_name='kittiDump',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='disable_overlay',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='overlay_linewidth',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='classwise_bbox_handler_config',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='postproc_classes',
  ...
  extensions=[],
  nested_types=[
 _BBOXHANDLERCONFIG_CLASSWISEBBOXHANDLERCONFIGENTRY],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
  ...
  serialized_end=843)
_INFERENCE = _descriptor.Descriptor(name='Inference',
  full_name='Inference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
...
ClasswiseBboxHandlerConfig = _reflection.GeneratedProtocolMessageType('ClasswiseBboxHandlerConfig', (_message.Message,), dict(BboxColor=(_reflection.GeneratedProtocolMessageType('BboxColor', (_message.Message,), dict(DESCRIPTOR=_CLASSWISEBBOXHANDLERCONFIG_BBOXCOLOR,
...
BboxHandlerConfig = _reflection.GeneratedProtocolMessageType('BboxHandlerConfig', (_message.Message,), dict(ClasswiseBboxHandlerConfigEntry=(_reflection.GeneratedProtocolMessageType('ClasswiseBboxHandlerConfigEntry', (_message.Message,), dict(DESCRIPTOR=_BBOXHANDLERCONFIG_CLASSWISEBBOXHANDLERCONFIGENTRY,
  __module__='iva.detectnet_v2.proto.inference_pb2'))),
...
Inference = _reflection.GeneratedProtocolMessageType('Inference', (_message.Message,), dict(DESCRIPTOR=_INFERENCE,
  __module__='iva.detectnet_v2.proto.inference_pb2'))

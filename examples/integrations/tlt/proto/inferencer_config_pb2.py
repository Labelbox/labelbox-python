...
_TENSORRTCONFIG = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_TENSORRTCONFIG_PARSER, _TENSORRTCONFIG_BACKENDDATATYPE],
    serialized_options=None,
    is_extendable=False,
    syntax='proto3',
    extension_ranges=[],
...
_TENSORRTCONFIG.fields_by_name[
    'backend_data_type'].enum_type = _TENSORRTCONFIG_BACKENDDATATYPE
_TENSORRTCONFIG.fields_by_name[
    'calibrator_config'].message_type = _CALIBRATORCONFIG
...
_INFERENCERCONFIG.fields_by_name[
    'tensorrt_config'].message_type = _TENSORRTCONFIG
_INFERENCERCONFIG.oneofs_by_name['model_config_type'].fields.append(
    _INFERENCERCONFIG.fields_by_name['tlt_config'])
_INFERENCERCONFIG.fields_by_name[
    'tlt_config'].containing_oneof = _INFERENCERCONFIG.oneofs_by_name[
        'model_config_type']
_INFERENCERCONFIG.oneofs_by_name['model_config_type'].fields.append(
    _INFERENCERCONFIG.fields_by_name['tensorrt_config'])
_INFERENCERCONFIG.fields_by_name[
    'tensorrt_config'].containing_oneof = _INFERENCERCONFIG.oneofs_by_name[
        'model_config_type']
...
CalibratorConfig = _reflection.GeneratedProtocolMessageType(
    'CalibratorConfig', (_message.Message,),
    dict(DESCRIPTOR=_CALIBRATORCONFIG,
         __module__='iva.detectnet_v2.proto.inferencer_config_pb2'))
_sym_db.RegisterMessage(CalibratorConfig)
TLTConfig = _reflection.GeneratedProtocolMessageType(
    'TLTConfig', (_message.Message,),
    dict(DESCRIPTOR=_TLTCONFIG,
         __module__='iva.detectnet_v2.proto.inferencer_config_pb2'))
_sym_db.RegisterMessage(TLTConfig)
TensorRTConfig = _reflection.GeneratedProtocolMessageType(
    'TensorRTConfig', (_message.Message,),
    dict(DESCRIPTOR=_TENSORRTCONFIG,
         __module__='iva.detectnet_v2.proto.inferencer_config_pb2'))
_sym_db.RegisterMessage(TensorRTConfig)
InferencerConfig = _reflection.GeneratedProtocolMessageType(
    'InferencerConfig', (_message.Message,),
    dict(DESCRIPTOR=_INFERENCERCONFIG,
         __module__='iva.detectnet_v2.proto.inferencer_config_pb2'))

...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/evaluation_config.proto',
  package='',
  syntax='proto3',
...
_EVALUATIONCONFIG_AP_MODE = _descriptor.EnumDescriptor(name='AP_MODE',
...
_EVALUATIONCONFIG_MINIMUMDETECTIONGROUNDTRUTHOVERLAPENTRY = _descriptor.Descriptor(name='MinimumDetectionGroundTruthOverlapEntry',
 ...
 _descriptor.FieldDescriptor(name='key',
   full_name='EvaluationConfig.MinimumDetectionGroundTruthOverlapEntry.key',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='value',
   full_name='EvaluationConfig.MinimumDetectionGroundTruthOverlapEntry.value',
   index=1,
   number=2,
   type=2,
   cpp_type=6,
  ...
  serialized_end=606)
_EVALUATIONCONFIG_EVALUATIONBOXCONFIG = _descriptor.Descriptor(name='EvaluationBoxConfig',
  full_name='EvaluationConfig.EvaluationBoxConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='minimum_height',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='maximum_height',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='minimum_width',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='maximum_width',
  ...
  serialized_end=782)
_EVALUATIONCONFIG_EVALUATIONBOXCONFIGENTRY = _descriptor.Descriptor(name='EvaluationBoxConfigEntry',
 ...
 _descriptor.FieldDescriptor(name='value',
  ...
  serialized_end=893)
_EVALUATIONCONFIG = _descriptor.Descriptor(name='EvaluationConfig',
  full_name='EvaluationConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='validation_period_during_training',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='first_validation_epoch',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='minimum_detection_ground_truth_overlap',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='evaluation_box_config',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='average_precision_mode',
  ...
  extensions=[],
  nested_types=[
 _EVALUATIONCONFIG_MINIMUMDETECTIONGROUNDTRUTHOVERLAPENTRY, _EVALUATIONCONFIG_EVALUATIONBOXCONFIG, _EVALUATIONCONFIG_EVALUATIONBOXCONFIGENTRY],
  enum_types=[
...
EvaluationConfig = _reflection.GeneratedProtocolMessageType('EvaluationConfig', (_message.Message,), dict(MinimumDetectionGroundTruthOverlapEntry=(_reflection.GeneratedProtocolMessageType('MinimumDetectionGroundTruthOverlapEntry', (_message.Message,), dict(DESCRIPTOR=_EVALUATIONCONFIG_MINIMUMDETECTIONGROUNDTRUTHOVERLAPENTRY,
  __module__='iva.detectnet_v2.proto.evaluation_config_pb2'))),
  EvaluationBoxConfig=(_reflection.GeneratedProtocolMessageType('EvaluationBoxConfig', (_message.Message,), dict(DESCRIPTOR=_EVALUATIONCONFIG_EVALUATIONBOXCONFIG,
  __module__='iva.detectnet_v2.proto.evaluation_config_pb2'))),
  EvaluationBoxConfigEntry=(_reflection.GeneratedProtocolMessageType('EvaluationBoxConfigEntry', (_message.Message,), dict(DESCRIPTOR=_EVALUATIONCONFIG_EVALUATIONBOXCONFIGENTRY,
  __module__='iva.detectnet_v2.proto.evaluation_config_pb2'))),

...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/bbox_rasterizer_config.proto',
  package='',
  syntax='proto3',
...
_BBOXRASTERIZERCONFIG_TARGETCLASSCONFIG = _descriptor.Descriptor(name='TargetClassConfig',
  full_name='BboxRasterizerConfig.TargetClassConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='cov_center_x',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='cov_center_y',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='cov_radius_x',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='cov_radius_y',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='bbox_min_radius',
  ...
  serialized_end=411)
_BBOXRASTERIZERCONFIG_TARGETCLASSCONFIGENTRY = _descriptor.Descriptor(name='TargetClassConfigEntry',
 ...
 _descriptor.FieldDescriptor(name='value',
  ...
  serialized_end=522)
_BBOXRASTERIZERCONFIG = _descriptor.Descriptor(name='BboxRasterizerConfig',
 ...
 _descriptor.FieldDescriptor(name='target_class_config',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='deadzone_radius',
  ...
  extensions=[],
  nested_types=[
 _BBOXRASTERIZERCONFIG_TARGETCLASSCONFIG, _BBOXRASTERIZERCONFIG_TARGETCLASSCONFIGENTRY],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
BboxRasterizerConfig = _reflection.GeneratedProtocolMessageType('BboxRasterizerConfig', (_message.Message,), dict(TargetClassConfig=(_reflection.GeneratedProtocolMessageType('TargetClassConfig', (_message.Message,), dict(DESCRIPTOR=_BBOXRASTERIZERCONFIG_TARGETCLASSCONFIG,
  __module__='iva.detectnet_v2.proto.bbox_rasterizer_config_pb2'))),
  TargetClassConfigEntry=(_reflection.GeneratedProtocolMessageType('TargetClassConfigEntry', (_message.Message,), dict(DESCRIPTOR=_BBOXRASTERIZERCONFIG_TARGETCLASSCONFIGENTRY,
  __module__='iva.detectnet_v2.proto.bbox_rasterizer_config_pb2'))),

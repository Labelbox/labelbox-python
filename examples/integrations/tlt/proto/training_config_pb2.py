...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/training_config.proto',
  package='',
  syntax='proto3',
  ...
  dependencies=[
 iva_dot_detectnet__v2_dot_proto_dot_cost__scaling__config__pb2.DESCRIPTOR, iva_dot_detectnet__v2_dot_proto_dot_learning__rate__config__pb2.DESCRIPTOR, iva_dot_detectnet__v2_dot_proto_dot_optimizer__config__pb2.DESCRIPTOR, iva_dot_detectnet__v2_dot_proto_dot_regularizer__config__pb2.DESCRIPTOR])
_TRAININGCONFIG = _descriptor.Descriptor(name='TrainingConfig',
  full_name='TrainingConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='batch_size_per_gpu',
 ...
 _descriptor.FieldDescriptor(name='cost_scaling',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='checkpoint_interval',
...
TrainingConfig = _reflection.GeneratedProtocolMessageType('TrainingConfig', (_message.Message,), dict(DESCRIPTOR=_TRAININGCONFIG,

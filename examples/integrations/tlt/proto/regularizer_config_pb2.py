...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/regularizer_config.proto',
  package='',
  syntax='proto3',
...
_REGULARIZERCONFIG_REGULARIZATIONTYPE = _descriptor.EnumDescriptor(name='RegularizationType',
...
_REGULARIZERCONFIG = _descriptor.Descriptor(name='RegularizerConfig',
...
RegularizerConfig = _reflection.GeneratedProtocolMessageType('RegularizerConfig', (_message.Message,), dict(DESCRIPTOR=_REGULARIZERCONFIG,

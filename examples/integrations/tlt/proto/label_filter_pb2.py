...
DESCRIPTOR = _descriptor.FileDescriptor(name='iva/detectnet_v2/proto/label_filter.proto',
  package='',
  syntax='proto3',
...
_LABELFILTER_BBOXDIMENSIONSLABELFILTER = _descriptor.Descriptor(name='BboxDimensionsLabelFilter',
  full_name='LabelFilter.BboxDimensionsLabelFilter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='min_width',
   ...
   json_name='minWidth',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='min_height',
   ...
   json_name='minHeight',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='max_width',
   ...
   json_name='maxWidth',
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='max_height',
  ...
  serialized_end=503)
_LABELFILTER_BBOXCROPLABELFILTER = _descriptor.Descriptor(name='BboxCropLabelFilter',
 ...
 _descriptor.FieldDescriptor(name='crop_bottom',
  ...
  serialized_end=647)
_LABELFILTER_SOURCECLASSLABELFILTER = _descriptor.Descriptor(name='SourceClassLabelFilter',
  full_name='LabelFilter.SourceClassLabelFilter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='source_class_names',
  ...
  serialized_end=719)
_LABELFILTER = _descriptor.Descriptor(name='LabelFilter',
  full_name='LabelFilter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='bbox_dimensions_label_filter',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='bbox_crop_label_filter',
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='source_class_label_filter',
  ...
  extensions=[],
  nested_types=[
 _LABELFILTER_BBOXDIMENSIONSLABELFILTER, _LABELFILTER_BBOXCROPLABELFILTER, _LABELFILTER_SOURCECLASSLABELFILTER],
  enum_types=[],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_LABELFILTER.oneofs_by_name['label_filter_params'].fields.append(_LABELFILTER.fields_by_name['bbox_dimensions_label_filter'])
...
_LABELFILTER.oneofs_by_name['label_filter_params'].fields.append(_LABELFILTER.fields_by_name['bbox_crop_label_filter'])
_LABELFILTER.fields_by_name['bbox_crop_label_filter'].containing_oneof = _LABELFILTER.oneofs_by_name['label_filter_params']
_LABELFILTER.oneofs_by_name['label_filter_params'].fields.append(_LABELFILTER.fields_by_name['source_class_label_filter'])
...
LabelFilter = _reflection.GeneratedProtocolMessageType('LabelFilter', (_message.Message,), dict(BboxDimensionsLabelFilter=(_reflection.GeneratedProtocolMessageType('BboxDimensionsLabelFilter', (_message.Message,), dict(DESCRIPTOR=_LABELFILTER_BBOXDIMENSIONSLABELFILTER,
  __module__='iva.detectnet_v2.proto.label_filter_pb2'))),
  BboxCropLabelFilter=(_reflection.GeneratedProtocolMessageType('BboxCropLabelFilter', (_message.Message,), dict(DESCRIPTOR=_LABELFILTER_BBOXCROPLABELFILTER,
  __module__='iva.detectnet_v2.proto.label_filter_pb2'))),
  SourceClassLabelFilter=(_reflection.GeneratedProtocolMessageType('SourceClassLabelFilter', (_message.Message,), dict(DESCRIPTOR=_LABELFILTER_SOURCECLASSLABELFILTER,
  __module__='iva.detectnet_v2.proto.label_filter_pb2'))),

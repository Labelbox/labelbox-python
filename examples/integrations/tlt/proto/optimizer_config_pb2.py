...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        iva_dot_detectnet__v2_dot_proto_dot_adam__optimizer__config__pb2.
        DESCRIPTOR
    ])
_OPTIMIZERCONFIG = _descriptor.Descriptor(
    ...
    serialized_end=175)
_OPTIMIZERCONFIG.fields_by_name[
    'adam'].message_type = iva_dot_detectnet__v2_dot_proto_dot_adam__optimizer__config__pb2._ADAMOPTIMIZERCONFIG
_OPTIMIZERCONFIG.oneofs_by_name['optimizer'].fields.append(
    _OPTIMIZERCONFIG.fields_by_name['adam'])
_OPTIMIZERCONFIG.fields_by_name[
    'adam'].containing_oneof = _OPTIMIZERCONFIG.oneofs_by_name['optimizer']
DESCRIPTOR.message_types_by_name['OptimizerConfig'] = _OPTIMIZERCONFIG
_sym_db.RegisterFileDescriptor(DESCRIPTOR)
OptimizerConfig = _reflection.GeneratedProtocolMessageType(
    'OptimizerConfig', (_message.Message,),
    dict(DESCRIPTOR=_OPTIMIZERCONFIG,
